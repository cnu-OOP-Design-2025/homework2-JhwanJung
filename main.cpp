...
void doNamespaceTest(){
    ...
    cout << "[IntCalc] 10.5 + 3.2 = " << IntCalc::add((int)10.5, (int)3.2) << endl;
    cout << "[IntCalc] 10.5 - 3.2 = " << IntCalc::subtract((int)10.5, (int)3.2) << endl;
    cout << "[IntCalc] 10.5 * 3.2 = " << IntCalc::multiply((int)10.5, (int)3.2) << endl;
    cout << "[IntCalc] 10.5 / 3.2 = " << IntCalc::divide((int)10.5, (int)3.2) << endl;
...
void doTest2(){
    ...
    addStudent(students, &numOfStudent, "Ana",   1051, 88.0f, 65.0f);
    addStudent(students, &numOfStudent, "Suji",  1052, 90.0f, 93.0f);
    addStudent(students, &numOfStudent, "Zhang", 1053, 100.0f, 40.0f);
